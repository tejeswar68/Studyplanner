...
function Home() {
  ...
  return (
    ...
    <div>
     ...
     <h1 className='text-center m-5'> PLANNED STUDY SESSIONS MAKES YOU UNSTOPABBLE!</h1>
...
<Col xs={12} md={6}>
<h3 className=' text-center mt-4  font-weight-bold fs-2'>FEATURES</h3>
 ...
 <p>NO RESTRICTION ON  COUNT OF SESSIONS.</p>
  ...
  <p></p>
  {!isLoggedIn && <Button href='login' variant='outline-warning' size='lg' className='m-3 w-50 mx-auto d-block'>CREATE SESSION</Button>}
  {isLoggedIn && <Button href='studysessions' variant='outline-warning' size='lg' className='m-3 w-50 mx-auto d-block'>SESSIONS</Button>}
 </div>
 </Col >
 </Row>
