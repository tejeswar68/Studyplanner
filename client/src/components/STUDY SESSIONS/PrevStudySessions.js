 ...
 console.log(time)
  ...
  useEffect(() => {
    sendRequest().then(data => setSess(data.courses.filter((obj)=>{
      ...
      return obj.endDate<date && obj.startDate<date;
     })));
  }, [date,time])
  console.log(sess);
  ...
  return (
    ...
    <h1 className='text-center mt-5' style={{color:'#324e8f'}}>COMPLETED-SESSIONS</h1>
...
export default PrevStudysessions;