...
function UpcomStudysessions() {
 ...
 console.log(time)
  ...
  return (
    ...
    <h1 className='text-center mt-5' style={{color:'#324e8f'}}>UPCOMING-SESSIONS</h1>
    <hr className='w-50 d-block mx-auto' style={{color:'#324e8f'}} />
...
export default UpcomStudysessions;